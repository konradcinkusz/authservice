> Generated by `/generate-master-prompt` from `docs/analysis/AUTH-MCP-01.md`, revision 6 (2026-09-23). Generated output: do not edit it. Correct the analysis through `/ticket-feedback` and generate again (GENERATE-MASTER-PROMPT.md §5).
...
- **Analysis:** `docs/analysis/AUTH-MCP-01.md`, revision 6, 2026-09-23. Gate decided, go.
...
If this prompt and the analysis disagree, the analysis wins (`docs/analysis/AUTH-MCP-01.md`, revision 6). The disagreement is a finding to send back through `/ticket-feedback`, not a judgement call to make mid-implementation. The analysis in turn wins over the brief (brief §10).
