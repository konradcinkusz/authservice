> Generated by `/generate-master-prompt` from `docs/analysis/AUTH-MCP-01.md`, revision 3 (2026-09-23). Generated output: do not edit it. Correct the analysis through `/ticket-feedback` and generate again (GENERATE-MASTER-PROMPT.md §5).
...
- **Analysis:** `docs/analysis/AUTH-MCP-01.md`, revision 3, 2026-09-23. Gate decided, go.
...
### 8.5 Findings the decisions rest on (analysis §1a)
...
### 8.6 Library defaults and their overrides (analysis §4.5)
...
### 8.7 Accepted risks (analysis §6.3, verbatim)
...
If this prompt and the analysis disagree, the analysis wins (`docs/analysis/AUTH-MCP-01.md`, revision 3). The disagreement is a finding to send back through `/ticket-feedback`, not a judgement call to make mid-implementation. The analysis in turn wins over the brief (brief §10).
