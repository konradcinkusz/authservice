...
- `SECURITY.md` lists "the Fly.io deployment configuration" as in scope, but the repository has held no Fly configuration since commit `47e8236`. *(Revision 5.)* Resolved in passing: AC9 rewrote that sentence, and it now names the reference configuration in `docs/DEPLOYMENT.md`.
